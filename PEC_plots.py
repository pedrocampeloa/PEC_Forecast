...
fig2, axes = plt.subplots(nrows=5, ncols=1, figsize=(7, 7))

axes[0].set_title("Brazil")
axes[0].plot(periodo, dados['CEE_BR_09'], label="09h")
axes[0].plot(periodo, dados['CEE_BR_15'], label="15h")
axes[0].plot(periodo, dados['CEE_BR_21'], label="21h")
axes[0].plot(periodo, dados['CEE_BR_MED'], label="Média")
axes[0].legend(loc='best')
axes[0].set_ylabel("KW/h")

axes[1].set_title("Southeast/Midwest")
axes[1].plot(periodo, dados['CEE_SECO_09'], label="09h")
axes[1].plot(periodo, dados['CEE_SECO_15'], label="15h")
axes[1].plot(periodo, dados['CEE_SECO_21'], label="21h")
axes[1].plot(periodo, dados['CEE_SECO_MED'], label="Média")
axes[1].legend(loc='best')
axes[1].set_ylabel("KW/h")

axes[2].set_title("South")
axes[2].plot(periodo, dados['CEE_SUL_09'], label="9h")
axes[2].plot(periodo, dados['CEE_SUL_15'], label="15h")    
axes[2].plot(periodo, dados['CEE_SUL_21'], label="21h")
axes[2].plot(periodo, dados['CEE_SUL_MED'], label="Média")
axes[2].legend(loc='best')    
axes[2].set_ylabel("KW/h")

axes[3].set_title("Northeast")
axes[3].plot(periodo, dados['CEE_NE_09'], label="9h")
axes[3].plot(periodo, dados['CEE_NE_15'], label="15h")
axes[3].plot(periodo, dados['CEE_NE_21'], label="21h")
axes[3].plot(periodo, dados['CEE_NE_MED'], label="Média")
axes[3].legend(loc='best')
axes[3].set_ylabel("KW/h")

axes[4].set_title("North")
axes[4].plot(periodo, dados['CEE_N_09'], label="9h")
axes[4].plot(periodo, dados['CEE_N_15'], label="15h")
axes[4].plot(periodo, dados['CEE_N_21'], label="21h")
axes[4].plot(periodo, dados['CEE_N_MED'], label="Média")
axes[4].legend(loc='best')
axes[4].set_ylabel("KW/h")
...
#Por setores
    ...
    #Brasil
plt.figure()
dados['CEE_BR_CSO'].plot(label='Comercial, Services and Others')
#    dados['CEE_BR_CP'].plot(label='Own Consumption')
...
dados['CEE_BR_RED'].plot(label='Residential')
...
plt.legend(loc='best')
plt.ylabel('KW/h')
plt.title('Brazil Power Electricity Consumption by Sector')
#plt.grid()
...
#tarifas média
plt.figure()
dados['TAR_BR_MED'].plot(label='Brazil')
dados['TAR_SECO_MED'].plot( label='Southeast/Midwest')
dados['TAR_SUL_MED'].plot(label='South')
dados['TAR_NE_MED'].plot( label='Northeast')
dados['TAR_N_MED'].plot(label='North')
plt.legend(loc='best')
plt.ylabel('R$/mWh')
...
fig2, axes = plt.subplots(nrows=2, ncols=1, figsize=(7, 4))
axes[0].set_title("Average Temperature")
axes[0].plot(periodo, dados['TEMP_BS_BR_MED'], label="BR")    
axes[0].plot(periodo, dados['TEMP_BS_NE_MED'], label="NE")
axes[0].plot(periodo, dados['TEMP_BS_SECO_MED'], label="SE/MW")
axes[0].plot(periodo, dados['TEMP_BS_SUL_MED'], label="S")
axes[0].plot(periodo, dados['TEMP_BS_N_MED'], label="N")
axes[0].legend(loc='center left')
axes[0].set_ylabel("oC")

axes[1].set_title("Average Adjusted Temperature")
axes[1].plot(periodo, dados['TEMPaj_BS_BR_MED'], label="BR")    
axes[1].plot(periodo, dados['TEMPaj_BS_NE_MED'], label="NE")
axes[1].plot(periodo, dados['TEMPaj_BS_SECO_MED'], label="SE/MW")
axes[1].plot(periodo, dados['TEMPaj_BS_SUL_MED'], label="S")
axes[1].plot(periodo, dados['TEMPaj_BS_N_MED'], label="N")
axes[1].legend(loc='best')
axes[1].set_ylabel("oC")
fig2.tight_layout()
plt.savefig('tempmedagreg.png')   
plt.show()


fig2, axes = plt.subplots(nrows=2, ncols=1, figsize=(7, 4))
axes[0].set_title("Average Temperature")
axes[0].plot(periodo, dados['TEMP_BS_BR_9'], label="9h")    
axes[0].plot(periodo, dados['TEMP_BS_BR_15'], label="15h")
axes[0].plot(periodo, dados['TEMP_BS_BR_21'], label="21h")
axes[0].plot(periodo, dados['TEMP_BS_BR_MED'], label="Average")
axes[0].legend(loc='best')
axes[0].set_ylabel("oC")

axes[1].set_title("Average Adjusted Temperature")
axes[1].plot(periodo, dados['TEMPaj_BS_BR_9'], label="9h")    
axes[1].plot(periodo, dados['TEMPaj_BS_BR_15'], label="15h")
axes[1].plot(periodo, dados['TEMPaj_BS_BR_21'], label="21h")
axes[1].plot(periodo, dados['TEMPaj_BS_BR_MED'], label="Average")
axes[1].legend(loc='center left')
axes[1].set_ylabel("oC")
fig2.tight_layout()
plt.savefig('temphourgreg.png')   
plt.show()
